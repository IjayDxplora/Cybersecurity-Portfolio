...
## What's Next
- Project 2: Microsoft Defender for Cloud — Threat Protection & Secure Score
- Project 3: Azure Security Center & Log Analytics
- Project 4: Azure Sentinel (SIEM) — Security Monitoring & Incident Response
